...
const me = require("./XeonCheems7.js");
nocache("../XeonCheems7.js", (module) =>
  console.log(
    color("[ CHANGE ]", "green"),
    color(`'${module}'`, "green"),
    "Updated"
    ...
    try {
      ...
      for (let num of participants) {
        ...
        if (anu.action == "add") {
          ...
          xeonbody = `@${xeonName.split("@")[0]} 𝙅𝙤𝙞𝙣𝙚𝙙 𝙏𝙤 𝙂𝙧𝙪𝙥 ${
            metadata.subject
          }`;
          ...
          xeonbody = `@${xeonName.split("@")[0]} 𝙇𝙚𝙖𝙫𝙞𝙣𝙜 𝙏𝙤 𝙂𝙧𝙪𝙥${
            metadata.subject
          }:`;
          XeonBotInc.sendMessage(anu.id, {
            text: xeonbody,
